var instafeedApp = (function instafeedLoad() {
    ...
    var Instafeed = function() {
        ...
        return a.prototype.run = function() {
            ...
            if (v.innerHTML = "", 204 === parseInt(a.meta.code)) return this.options.admin && (v.innerHTML = "\u26A0\uFE0F " + a.meta.error_message), console.log("Error from API: " + a.meta.error_message), !1;
            if (200 !== a.meta.code) return this.options.admin && "Unsupported request - method type: get" === a.meta.error_message ? v.innerHTML = "<div style='text-align:left'>\u26A0\uFE0F <b>Facebook team is currently investigating an issue that is affecting your Instagram account</b><br><br><b>Update Oct 26th</b> - Facebook team continues investigating this issue as a high priority. You can follow updates from Facebook team <a style='color:black;text-decoration:underline!important;' href='https://developers.facebook.com/support/bugs/600724068502172/?join_id=f16463001b002e8' target='_blank'>here</a>.<br><br> Your account will reconnect automatically once that issue is resolved.<br/><br/>Thank you for your patience and understanding.</div>" : this.options.admin && (v.innerHTML = " \u26A0\uFE0F Your Instagram account is not properly connected: " + a.meta.error_message + "<br><br><b>Reconnect your Instagram account and confirm you provide permissions</b>", this.options.error.call(this, "No connection")), !1;
            if (null !== this.options.success && "function" == typeof this.options.success && this.options.success.call(this, a), "undefined" == typeof document || null === document) return !1;
            q = a.data, f = document.createDocumentFragment(), g = "", h = "", o = "", w = document.createElement("div");
            var x = parseInt(100 - this.options.space),
                y = 0,
                z = 0;
            y = 0 < parseInt(this.options.autoLayout) ? parseFloat(100 / getAutoColumns(v.clientWidth)).toFixed(6) : isMobileDevice() && validateCharge(this.options.charge) ? parseFloat(100 / this.options.columnsMobile).toFixed(6) : parseFloat(100 / this.options.columns).toFixed(6), z = y, 2 <= parseInt(this.options.layout) && (z = parseFloat(2 * y).toFixed(6));
            var A = "",
                B = "";
            validateCharge(this.options.charge) && 0 < parseInt(this.options.likes) && 4 !== parseInt(this.options.apiVersion) && (A = "<div class='likes'><span style='padding-right: 5px;'><svg width='10' height='10' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z' fill='white'></path></svg></span>{{likes}}<!--<span style='width: 10px;padding-right: 5px;padding-left: 5px;'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512'><path d='M416 192c0-88.4-93.1-160-208-160S0 103.6 0 192c0 34.3 14.1 65.9 38 92-13.4 30.2-35.5 54.2-35.8 54.5-2.2 2.3-2.8 5.7-1.5 8.7S4.8 352 8 352c36.6 0 66.9-12.3 88.7-25 32.2 15.7 70.3 25 111.3 25 114.9 0 208-71.6 208-160zm122 220c23.9-26 38-57.7 38-92 0-66.9-53.5-124.2-129.3-148.1.9 6.6 1.3 13.3 1.3 20.1 0 105.9-107.7 192-240 192-10.8 0-21.3-.8-31.7-1.9C207.8 439.6 281.8 480 368 480c41 0 79.1-9.2 111.3-25 21.8 12.7 52.1 25 88.7 25 3.2 0 6.1-1.9 7.3-4.8 1.3-2.9.7-6.3-1.5-8.7-.3-.3-22.4-24.2-35.8-54.5z' fill='white'></path></svg></span> {{comments}}--></div>", B = "<span><span style='padding-right: 5px;'><svg width='10' height='10' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z' fill='grey'></path></svg> {{likes}}</span> <!--<span>&#10078; {{comments}}</span>-->");
            var C = "<div style='width:" + x + "%;height:" + x + "%;' class='instafeed-overlay {{video}}'>" + A + "</div>",
                D = "<div class='instafeed-container' style='width:" + y + "%;padding-top:" + z + "%;'><img class='js-lazy-image' style='width:" + x + "%;height:" + x + "%;' src='//" + appDomain + "/assets/img/placeholder.gif' data-src='{{image}}' alt='{{captionAlt}}' />" + C + "</div>",
                E = "",
                F = "";
            for (1 === parseInt(this.options.openIg) ? D = "<a href='{{link}}' target='_blank' rel='noopener'>" + D + "</a>" : 3 === parseInt(this.options.openIg) && (this.options.admin && (F = "<div class='products-tagging'><object><a href='#{{id}}-" + this.options.target + "' id='search' data-picture-id='{{fullId}}'><b><button class='btn primary'>Tag products</button></b></a></object></div><div class='tagging-message' id='tagging-{{fullId}}'></div>"), D = "<a href='#{{id}}-" + this.options.target + "'>" + D + "</a>", E = "<div class='instafeed-lightbox' id='{{id}}-" + this.options.target + "'><div class='lightbox-instagram' role='dialog' aria-labelledby='{{id}}-" + this.options.target + "' aria-modal='true'><div class='instafeed-post-image'>{{imageFullHtml}}</div><div class='description'><div class='instafeed-header'><div class='close-button'><a style='height:25px;width:25px;display:block!important;position:relative;background: transparent;' aria-label='close button' href='#_' id='close-button-url'></a></div><img src='//" + appDomain + "/assets/img/placeholder.gif' data-feed-id='" + this.options.target + "' class='profile-picture js-lazy-image' data-src='{{userPicture}}' alt='instagram profile picture' /><object class='name-section'><a class='fullname' href='https://www.instagram.com/{{username}}/' target='_blank' rel='noopener'><div class='fullname instafeed-text' data-feed-id='" + this.options.target + "'>{{username}}</div></a></object></div><hr><div class='box-content'><div class='sub-header'><div class='post-engagement'>" + B + "</div><div class='arrows'><object><a href='#{{minusId}}-" + this.options.target + "'><img src='//" + appDomain + "/assets/img/placeholder.gif' alt='previous image' /></a></object><object><a href='#{{plusId}}-" + this.options.target + "'><img src='//" + appDomain + "/assets/img/placeholder.gif' alt='next image' /></a></object></div></div>" + F + " {{taggedProduct}}<div class='instafeed-caption'>{{caption}}</div></div><div class='post-date'><span style='padding-left:8px;'>{{date}}</span> \u2022 <object><a href='{{link}}' target='_blank' rel='noopener' class='follow'>View on Instagram</a></object></div></div></div></div>"), k = 0, s = q.length; k < s; k++) {
                l = q[k];
                var G = "",
                    H = l.user.followers;
                ...
                if (n = this._makeTemplate(D, {
                        ...
                        captionAlt: "Instagram post with the caption: " + escapeHtml(this._getObjectProperty(l, "caption.text").substring(0, 64)) + "...",
                        ...
                        comments: shortenLargeNumber(l.comments.count, 1),
                        location: this._getObjectProperty(l, "location.name")
                    }), 1 === parseInt(this.options.layout) || 3 === parseInt(this.options.layout)) {
                    var O = 0;
                    O = 0 < parseInt(this.options.autoLayout) ? getAutoColumns(v.clientWidth) : isMobileDevice() && validateCharge(this.options.charge) ? this.options.columnsMobile : this.options.columns;
                    var P = Math.ceil(this.options.picturesLoaded / O);
                    let a = "";
                    1 === this.options.picturesLoaded && (a = "<div style='position:relative;'>"), n = a + "<span class=\"slide-page\" data-slide-page=\"" + P + "\" >" + n + "</span>"
                }
                if (g += n, h += o, this.options.picturesLoaded >= this.options.picturesNeeded || a.data.length === this.options.picturesLoaded) {
                    (1 === parseInt(this.options.layout) || 3 === parseInt(this.options.layout)) && a.data.length > O && (g += "<a href=\"#\" aria-label=\"Scroll Instagram feed to the left\" role=\"link\" class=\"slider-arrow\" onclick=\"instafeedSlide(-1);return false;\" style=\"left:5px;\">&#10094;</a>", g += "<a href=\"#\" aria-label=\"Scroll Instagram feed to the right\" role=\"link\" alt=\"instafeed right arrow\" class=\"slider-arrow\" onclick=\"instafeedSlide(1);return false;\" style=\"right:5px;\">&#10095;</a>", g += "</div>"), g += h;
                    break
                }
            }
            ...
            v.innerHTML = "";
            var Q = "";
            if (validateCharge(this.options.charge) && 5 === this.options.apiVersion && 0 < parseInt(this.options.showFollowers) && (Q = "<h3>" + shortenLargeNumber(H) + " followers"), 0 < this.options.title.length) {
                var R = document.createElement("h2");
                R.innerHTML = this.options.title + Q, v.insertBefore(R, v.firstChild)
            }
            return v.appendChild(f), (1 === parseInt(this.options.layout) || 3 === parseInt(this.options.layout)) && (v.addEventListener("swiped-left", function() {
                instafeedSlide(1)
            }), v.addEventListener("swiped-right", function() {
                instafeedSlide(-1)
            }), instafeedSlide(0)), lazyLoading(), !0
        }, a.prototype._buildUrl = function() {
            let a, b, c = "";
            b = this.options.forceUpdate ? 1 : 0;
            let d = window.location.pathname.includes("/products/");
            if (d) {
                let a = window.location.pathname.substring(window.location.pathname.indexOf("/products/") + 10);
                0 < a.length && (c = "&handle=" + a)
            }
            return a = "https://instafeed.nfcube.com/feed/v" + this.options.apiVersion + "?charge=" + this.options.charge + "&fu=" + b + "&limit=" + this.options.picturesNeeded + "&account=" + this.options.shopOrigin + "&fid=" + this.options.feedId + "&hash=" + this.options.hash + c, a
    ...
    function() {
        function a() {
            ...
            if (b = document.getElementById("video-" + d.substring(d.lastIndexOf("#") + 1, d.indexOf("-")) + "-instafeed"), c = document.getElementById("video-" + a.substring(a.lastIndexOf("#") + 1, a.indexOf("-")) + "-instafeed"), b && (console.log("pause"), b.pause(), b.onplay = function() {
                    "#_" === a && b.pause()
        ...
        }, loadCss(), window.addEventListener("hashchange", a, !1), window.addEventListener("keydown", function(a) {
            const b = a.key;
    ...
    if (document.getElementById('insta-feed') !== null) {
        var feed = new Instafeed({
            account: 'iamdesigning6428',
            hash: '714b10dba62fbbeda746f71997569fd9',
            apiVersion: 4,
            shopOrigin: 'phono-demo.myshopify.com',
            title: '',
            openIg: 3,
            space: 0,
            likes: 1,
