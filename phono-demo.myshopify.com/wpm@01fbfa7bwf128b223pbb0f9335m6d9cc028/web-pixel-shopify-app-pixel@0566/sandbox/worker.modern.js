...
(() => {
                    ...
                    var a = "function",
                        ...
                        H = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                var e, t = {};
                                return t.name = o, t.version = o, V.call(t, i, d.browser), t.major = typeof(e = t.version) === l ? e.replace(/[^\d\.]/g, "").split(".")[0] : o, r && r.brave && typeof r.brave.isBrave == a && (t.name = "Brave"), t
                            }, this.getCPU = function() {
                                var e = {};
                                return e.architecture = o, V.call(e, i, d.cpu), e
                            }, this.getDevice = function() {
                                var e = {};
                                return e.vendor = o, e.model = o, e.type = o, V.call(e, i, d.device), !e.type && u && u.mobile && (e.type = h), "Macintosh" == e.model && r && typeof r.standalone !== s && r.maxTouchPoints && r.maxTouchPoints > 2 && (e.model = "iPad", e.type = g), e
                            }, this.getEngine = function() {
                                var e = {};
                                return e.name = o, e.version = o, V.call(e, i, d.engine), e
                            }, this.getOS = function() {
                                var e = {};
                                return e.name = o, e.version = o, V.call(e, i, d.os), !e.name && u && "Unknown" != u.platform && (e.name = u.platform.replace(/chrome os/i, D).replace(/macos/i, j)), e
                                ...
                                return i = typeof e === l && e.length > 350 ? z(e, 350) : e, this
                            }, this.setUA(i), this
                        };
                    H.VERSION = "1.0.34", H.BROWSER = F([d, m, "major"]), H.CPU = F([p]), H.DEVICE = F([u, f, b, w, h, v, g, y, x]), H.ENGINE = H.OS = F([d, m]), typeof t !== s ? (e.exports && (t = e.exports = H), t.UAParser = H) : r.amdO ? (i = function() {
                        return H
    ...
    r.amdO = {}, (() => {
        ...
        function a(r) {
            ...
            return {
                ...
                async call(r, o) {
                    ...
                    try {
                        const r = (u = c, Boolean(u && u[e] && u[t]) ? [a, ...c[i]] : [a]);
            ...
            function l(n, a) {
                if ("object" == typeof n) {
                    ...
                    if (Array.isArray(n)) return n.map((e => l(e, a)));
                    if (o in n) {
                        const o = n["_@f"];
                        ...
                        let s = 0,
                            l = !1;
                        const u = () => {
                                s -= 1, 0 === s && (l = !0, c.delete(o), r.release(o))
                            },
                            d = () => {
                                s += 1
                            },
                            b = new Set(a),
                            f = (...e) => {
                                if (l) throw new Error("You attempted to call a function that was already released.");
                                if (!c.has(o)) throw new Error("You attempted to call a function that was already revoked.");
                                return r.call(o, e)
                            };
        ...
        const l = "production",
            u = "0.0.368",
            d = "01fbfa7bwf128b223pbb0f9335m6d9cc028";
        ...
        class w extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, w)
            }
        }
        ...
        function E(e, t = self) {
            var r;
            R(t, { ...e ? O : S,
                fetch: (r = t.fetch, Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), v(self, "String", {
                    writable: !1,
                    configurable: !1
                }), v(self, "Request", {
                    writable: !1,
        ...
        const I = function() {
            ...
            try {
                ...
                const i = r ? self : function({
                    ...
                    const {
                        parent: t
                    } = self, r = () => t.postMessage("remote-ui::ready", e);
                ...
                e = function(e, {
                    ...
                    return c.addEventListener("message", m), {
                        ...
                        replace(e) {
                            const t = c;
                            c = e, t.removeEventListener("message", m), e.addEventListener("message", m)
                        },
                        expose(e) {
                        ...
                        terminate() {
                            f(2, void 0), h(), c.terminate && c.terminate()
                        }
                    };
                    ...
                    function h() {
                        var e;
                        o = !0, l.clear(), u.clear(), null === (e = b.terminate) || void 0 === e || e.call(b), c.removeEventListener("message", m)
                    }
                }(i, {
                        ...
                        return new Promise(((r, i) => {
                            (async () => {
                                try {
                                    ...
                                    try {
                                        const e = f();
                                        if (e && (n.browser.sendBeacon = b), E(e), !e) {
                                            ...
                                            }(n.browser, o, e), self.document.title = t
                                        }
                            ...
                            try {
                                b = function(e, t) {
                                    ...
                                    const i = {
                                        ...
                                        columnNumber: "1",
                                        method: t.context,
                                        file: "https://cdn.shopify.com/s01fbfa7bwf128b223pbb0f9335m6d9cc028m.js"
                                    };
