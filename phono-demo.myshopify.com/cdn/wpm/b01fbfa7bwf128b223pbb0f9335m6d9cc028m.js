(() => {
    var e = {
            ...
            700: function(e, t, n) {
                ...
                ! function(r, i) {
                    ...
                    var a = "function",
                        ...
                        z = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                ...
                                var e = {};
                                return e.vendor = i, e.model = i, e.type = i, V.call(e, o, d.device), !e.type && u && u.mobile && (e.type = w), "Macintosh" == e.model && n && typeof n.standalone !== s && n.maxTouchPoints && n.maxTouchPoints > 2 && (e.model = "iPad", e.type = v), e
                    ...
                    z.VERSION = "1.0.34", z.BROWSER = B([d, m, "major"]), z.CPU = B([h]), z.DEVICE = B([u, p, f, b, w, g, v, y, E]), z.ENGINE = z.OS = B([d, m]), typeof t !== s ? (e.exports && (t = e.exports = z), t.UAParser = z) : n.amdO ? (o = function() {
                        return z
    ...
    n.amdO = {}, (() => {
        ...
        const be = "production",
            we = "0.0.368",
            ve = "modern",
            ge = "01fbfa7bwf128b223pbb0f9335m6d9cc028",
            ye = {
            ...
            for (const n in e)
                if (Object.prototype.hasOwnProperty.call(e, n)) {
                    const o = n.replace(/[A-Z]/g, (e => `_${e}`)).toLowerCase(),
                        r = e[n];
                    t[o] = null !== r && "object" == typeof r ? Ue(r) : r
                }
            return t
        }
        var je = n(700),
                        ...
                        try {
                            l = function(e, t) {
                                ...
                                const o = {
                                    ...
                                    columnNumber: "1",
                                    method: t.context,
                                    file: "https://cdn.shopify.com/b01fbfa7bwf128b223pbb0f9335m6d9cc028m.js"
                                };
                                if (e.stackTrace || e.stack || e.description) {
                                    n = e.stack.split("\n")[0];
                                    const t = e.stack.match(/([0-9]+):([0-9]+)/);
                                    if (t && t.length > 2 && (o.lineNumber = t[1], o.columnNumber = t[2], parseInt(o.lineNumber, 10) > 1e5)) throw new Ge
                                }
                                return {
        ...
        function He(e, t = !1) {
            const n = {
                ...
                payload: Ue(e.payload),
                metadata: {
                    event_created_at_ms: Je()
                }
            };
            qe.push(n), t ? We() : void 0 === ze && (ze = setTimeout(We, 500))
        }
        ...
        function We({
            ...
            qe.length = 0,
                function(e, t) {
                    ...
                    ! function(e, t) {
                        const n = `${Ke}/.well-known/shopify/monorail/unstable/produce_batch`;
                        try {
        ...
        class et {
            constructor({
                ...
                this.channelSubscribers = new Map, this.replayQueue = void 0, this.bufferSize = void 0, this.replayKeep = void 0, this.subscribeAllKey = void 0, this.eligibility = void 0, this.bufferSize = e, this.replayKeep = t, this.subscribeAllKey = n, this.replayQueue = new Ze(e, t), this.eligibility = null != o ? o : Qe
            }
            publish(e, t, n = {}) {
                var o;
        ...
        const nt = {
            all_events: tt.Meta,
            all_standard_events: tt.Meta,
            all_custom_events: tt.Meta,
            all_dom_events: tt.Meta,
            checkout_address_info_submitted: tt.Standard,
            checkout_completed: tt.Standard,
            checkout_started: tt.Standard,
            payment_info_submitted: tt.Standard,
            collection_viewed: tt.Standard,
            checkout_contact_info_submitted: tt.Standard,
            page_viewed: tt.Standard,
            product_added_to_cart: tt.Standard,
            product_removed_from_cart: tt.Standard,
            product_viewed: tt.Standard,
            product_variant_viewed: tt.Standard,
            search_submitted: tt.Standard,
            cart_viewed: tt.Standard,
            checkout_shipping_info_submitted: tt.Standard,
            input_changed: tt.Dom,
            input_blurred: tt.Dom,
            input_focused: tt.Dom,
            form_submitted: tt.Dom,
            clicked: tt.Dom,
            custom_event: tt.Custom
        };
        ...
        function rt(e) {
            return ot(e) === tt.Standard
        }

        function it(e) {
            return ot(e) === tt.Dom
        }
        const at = ["checkout_completed", "checkout_started"],
            st = (e, t, n) => {
                const {
        ...
        const lt = ["[object String]", "[object Number]", "[object Boolean]", "[object Undefined]", "[object Null]"];
        ...
        const pt = e => ({ ...e,
            clientId: ft(document.cookie)._shopify_y,
        ...
        const Et = "all_standard_events",
            _t = "all_custom_events",
            xt = "all_dom_events";
        ...
        function Ct(e) {
            ...
            return {
                publish(n, o, i) {
                    ...
                    if (!rt(n)) return !1;
                    if ("checkout_completed" === n && ct() && -1 !== document.cookie.indexOf("loggedConversion2=1")) return !1;
                    const l = ut(o);
                    ...
                    return function(e) {
                        ...
                        }(u.name) && (d = u.data.checkout.token), Xe("eventPublish", {
                            version: we,
                            bundleTarget: ve,
                        ...
                        }(n), r || ce() || (r = !0, f = e.shopId, p = e.surface || "unknown", wt.add((() => function(e, t) {
                            ht || (ht = !0, Xe("consentAccepted", {
                                version: we,
                                bundleTarget: ve,
                                shopId: e,
                                surface: t,
                ...
                subscribe(e, r, i = {}) {
                    const a = e => {
                        ...
                        Xe("subscriberEventEmit", {
                            ...
                            pixelAppId: yt(i.pixelRuntimeConfig),
                    ...
                    if ("all_events" === e) {
                        const e = t.subscribe(Et, a, i),
                            r = n.subscribe(_t, a, i),
                            s = o.subscribe(xt, a, i);
                        return () => {
                            const t = e(),
                                n = r(),
                                o = s();
                    ...
                    return e === _t ? n.subscribe(_t, a, i) : e === Et || rt(e) ? t.subscribe(e, a, i) : he("web_pixels_dom_analytics") && (e === xt || it(e)) ? o.subscribe(e, a, i) : n.subscribe(e, a, i)
                }
            }
        }
        ...
        const Tt = ["31014027265", "28638674945", "44186959873"];
        const St = Symbol.for("RemoteUi::Retain"),
            kt = Symbol.for("RemoteUi::Release"),
            Nt = Symbol.for("RemoteUi::RetainedBy");
        class It {
            constructor() {
                this.memoryManaged = new Set
            }
            add(e) {
                this.memoryManaged.add(e), e[Nt].add(this), e[St]()
            }
            release() {
                for (const e of this.memoryManaged) e[Nt].delete(this), e[kt]();
                this.memoryManaged.clear()
            }
        }

        function Rt(e) {
            return Boolean(e && e[St] && e[kt])
        }
        ...
        function Pt(e, {
            ...
            const n = Rt(e);
            if (n && e[St](), t) {
                if (Array.isArray(e)) return e.reduce(((e, n) => Pt(n, {
                    deep: t
                }) || e), n);
                if ("object" == typeof e && null != e) return Object.keys(e).reduce(((n, o) => Pt(e[o], {
                    deep: t
                }) || n), n)
            }
            return n
        ...
        async function Ut({
            ...
            const {
                search: o
            } = self.location, r = t.id, i = [Ie(n), "/wpm", `@${ge}`, `/web-pixel-${r}`, `@${t.scriptVersion}`, "/sandbox", "/modern", /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, o];
            if (n.match(/spin\.dev\/?/)) {
                const e = o.length ? "&" : "?";
        ...
        function jt(e, t, n, o, r, i = !1) {
            ...
            return {
                analytics: {
                    subscribe: (r, a, s) => (i && Pt(a), e.subscribe(r, a, { ...s,
        ...
        async function Bt({
            ...
            let a;
            const s = `web-pixel-sandbox-${e.type}-${e.id}-${e.runtimeContext}-${ge}`;
            switch (e.runtimeContext) {
                case gt.Strict:
                    a = await async function({
                        ...
                        const o = t.id,
                            r = [Ie(n), "/wpm", `@${ge}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", "/worker.modern.js"];
            ...
            if (ge !== f.hashVersion) {
                const t = new Error(`The main bundle hash (${ge}) does not match the sandbox hash (${f.hashVersion})`);
                Ve(t, {
                    severity: "warning",
                    pixelId: e.id,
                    pixelType: e.type,
            ...
            if ("error" === f.status) throw "extend" !== f.errorLocation && Ve(f.error, {
                pixelId: e.id,
                pixelType: e.type,
                runtimeContext: e.runtimeContext,
                shopId: n,
        ...
        async function $t({
            ...
            }(String(e.apiClientId), i)), await Promise.all([bt(), (f = (e, n) => t.subscribe(e, n, {
                pixelRuntimeConfig: {
        ...
        const Yt = function() {
            ...
            try {
                const e = Ne();
                return n.payload.status = "loaded", He(n), {
                    init(n) {
                        ...
                        p = f, window.addEventListener("pagehide", (() => {
                            var e, t;
                            p.payload.pageDuration = null === (e = Oe("page:session")) || void 0 === e || null === (t = e.measurement) || void 0 === t ? void 0 : t.duration, He(p), We({
                                skipXhr: !0
                            })
                        }));
                        const m = Ct(n),
                        ...
                        try {
                            ...
                            if (/^web-pixel-sandbox/.test(self.name)) {
                                ...
                                throw h.library = "browser", Ve(e, h), e
                            }
                            if (!r) {
                            ...
                            if (!At(u)) {
                                const e = new $e(`WebPixelsManager: storefrontBaseUrl is not a valid absolute URL: ${u}`);
                                throw Ve(e, h), e
                            }
                            if (!i) {
                            ...
                            if (!At(i)) {
                                const e = new $e(`WebPixelsManager: cdnBaseUrl is not a valid absolute URL: ${i}`);
                                throw Ve(e, h), e
                            }
                            ...
                            }(f))).catch((() => {})), Promise.all(e.waiting).catch((() => {})), "checkout-one" !== s && (_(m.publish, c), he("web_pixels_dom_analytics") && function(e) {
                                const t = function() {
                                    let e = !1;
                                    try {
                                        const t = {
                                ...
                                function(e, t) {
                                    Ft("submit", (t => {
                                        ...
                                        for (let e = 0; e < n.elements.length; e++) {
                                            ...
                                            (t instanceof HTMLInputElement || t instanceof HTMLSelectElement || t instanceof HTMLTextAreaElement || t instanceof HTMLButtonElement) && o.push(Vt(t))
                                        }
                            ...
                            }(m)), b.payload.status = "initialized", He(b);
                            const n = {
                            ...
                            if (he("web_pixels_visitor_api")) {
                                ...
                                const e = (v = {
                                    ...
                                    visitor: (e, t) => function(e, t, n) {
                                        ...
                                        if (!o.valid) throw new Kt(o.error || "Invalid input payload to visitorApi");
                                        const r = { ...e,
                                            ...t,
                                            ...n
                                        };
                                        return bt().then((() => Xe("visitor", r))).catch((() => Ve("visitor error", {
                                            severity: "error",
                            ...
                            return g instanceof $e || Ve(g, {
                                context: "refactor/init",
                                shopId: r,
                                initConfig: n
                            }), self.console && console.error(g), b.payload.status = "failed", b.payload.errorMsg = null == g ? void 0 : g.message, He(b), f.payload.runtimeErrorCaught = "true", o
                        }
                        var v
                    }
                }
            } catch (r) {
                return r instanceof $e || Ve(r, {
                    context: "refactor/createWebPixelsManager"
                }), self.console && console.error(r), n.payload.status = "manager-create-error", n.payload.errorMsg = null == r ? void 0 : r.message, He(n, !0), {
                    init: () => o
                }
            }
        }();
        self.webPixelsManager = Yt
    })()
})();