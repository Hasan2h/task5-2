                ...
                t.parseDocumentCookie = v, t.cookieImpl = {
                    ...
                    allowed: function(e) {
                        if (c.isMerchantOnGranularConsentBeta()) {
                            if ([u.shortTermKey, u.longTermKey, u.deprecatedShortTermKey, u.deprecatedLongTermKey].includes(e)) return c.haveConsentForMarketingOrAnalytics();
                            var t = function(e) {
                                var t;
                    ...
                    s = function() {
                        ...
                        return e.prototype.fetchOrSet = function(e, t, n, o) {
                            ...
                            var a = r.read(n) || r.read(t),
                                s = !o;
                            a || (a = c(), s = !0, o && !this.isCookieSetServerSideEventFired && (i.logMetricToMonorail("serverSideCookieNotSet_" + n), this.isCookieSetServerSideEventFired = !0)), s && (r.write(t, a, e), r.write(n, a, e));
                    ...
                    C = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            try {
                                ...
                                } else r = (null === (o = window.Shopify) || void 0 === o ? void 0 : o.evids) && a ? window.Shopify.evids(a, {
                                    analyticsFramework: "trekkie"
                                }) : d.buildToken()
                            } catch (e) {
                                r = d.buildToken()
