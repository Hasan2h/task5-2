...
Line 87:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 140:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 144:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 156:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 253:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 254:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 255:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 270:2 Transforming const to the configured target environment ("es5") is not supported yet
