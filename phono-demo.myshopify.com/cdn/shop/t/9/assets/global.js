...
Line 113:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 114:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 115:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 151:40 Transforming default arguments to the configured target environment ("es5") is not supported yet
...
// For accordian
const accordionTrigger = document.querySelectorAll('.accordion_trigger_title');

accordionTrigger.forEach(trigger => trigger.addEventListener('click', toggleAccordion));

function toggleAccordion() {
    const items = document.querySelectorAll('.accordion_wrapper');
...
//For default collapsible content
