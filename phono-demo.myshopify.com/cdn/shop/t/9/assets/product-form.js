...
Line 54:12 Transforming const to the configured target environment ("es5") is not supported yet
Line 67:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 88:22 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 88:36 Transforming default arguments to the configured target environment ("es5") is not supported yet
